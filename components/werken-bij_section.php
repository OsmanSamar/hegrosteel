...
<div class="werken-bij_section">
    <div class="row">
        <div class="col-12 col-md-6 col-lg-5 offset-lg-1  mb-4 mb-lg-0" data-aos="fade-up" data-aos-offset="100"
        ...
        <div class="col-lg-5 col-md-6 mt-auto" data-aos="fade-up" data-aos-offset="100" data-aos-delay="250"
        ...
        <div class="row">
            <div class="col-lg-5 offset-lg-6 col-xl-4 col-md-6 offset-md-6 mt-4" data-aos="fade-up"
                data-aos-offset="100" data-aos-delay="300" data-aos-duration="1000" data-aos-easing="ease-in-out">
