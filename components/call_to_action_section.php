...
<div class="call_to_action_section">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-5 col-xl-8 d-flex flex-column justify-content-start align-items-start mb-5" data-aos="fade-up"
            ...
            <div class=" col-md-6 col-lg-3 offset-lg-1 col-xl-3 offset-xl-1 d-flex align-items-center justify-content-center">
